...
public class phat extends javax.swing.JDialog {
    ...
    String maPT;
    PhieuTraPanel ptpn ;
    public phat(java.awt.Frame parent, boolean modal,String maPhieuTra,PhieuTraPanel panel) {
        super(parent, modal);
        initComponents();
        this.ptpn = panel;
        setLocationRelativeTo(null);
        bangQD.getTableHeader().setBackground(new java.awt.Color(102, 178, 255));
