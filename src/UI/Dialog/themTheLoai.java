 ...
 * @author tung7
 */
public class themTheLoai extends javax.swing.JDialog {
    TheLoaiPanel tpn = new TheLoaiPanel();
    public themTheLoai(java.awt.Frame parent, boolean modal, TheLoaiPanel panel) {
        super(parent, modal);
        this.tpn = panel;
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Thêm thể loại", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 15))); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(maTL)
                            .addComponent(tL, javax.swing.GroupLayout.DEFAULT_SIZE, 186, Short.MAX_VALUE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(142, 142, 142)
    ...
    private void confirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmActionPerformed
        ...
        theLoai.setMaTheLoai(maTL.getText());
        theLoai.setTheLoai(tL.getText());
        theLoai.setTrangThai(1);
        tpn.getTheLoaiBLL().themTheLoai(theLoai);
